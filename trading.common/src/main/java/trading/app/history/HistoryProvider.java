...
public interface HistoryProvider {
	 ...
	 * @param instrumentId
	 * @param startDate
	 *            latest date before our range. Not included in result
	 * @param count
	 *            item count
	 * @return
	 */
	public abstract List<Level1> findLevel1After(int instrumentId,
	 ...
	 * @param instrumentId
	 * @param startDate
	 *            first date included in result.
	 * @param count
	 * @return
	 */
	public abstract List<Level1> findLevel1From(int instrumentId,
			Date startDate, int count);
	 ...
	 * @param instrumentId
	 * @param endDate
	 *            latest date included in result
	 * @param count
	 *            item count
	 * @return
	 */
	public abstract List<Level1> findLevel1NotAfter(int instrumentId,
	 ...
	 * @return
	 */
	public abstract List<Level1> findLevel1Range(int instrumentId, Date start,
			Date end);
