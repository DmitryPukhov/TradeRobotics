...
public class TestPanel extends JPanel {
	...
	public TestPanel(NeuralContext context, NeuralService service) {
		...
		springLayout.putConstraint(SpringLayout.WEST, progressBar, 0, SpringLayout.WEST, chartsPanel);
		...
		springLayout.putConstraint(SpringLayout.SOUTH, progressBar, -6, SpringLayout.NORTH, lblIteration);
		springLayout.putConstraint(SpringLayout.SOUTH, lblIteration, -23, SpringLayout.NORTH, chartsPanel);
		add(lblIteration);
		
		// Continious training check boc
		JCheckBox chckbxContinuousTraining = new JCheckBox("Continuous Training");
		...
		springLayout.putConstraint(SpringLayout.NORTH, chckbxContinuousTraining, 10, SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.WEST, chckbxContinuousTraining, 10, SpringLayout.WEST, this);
...
//		RegularTimePeriod x = RegularTimePeriod.createInstance(Millisecond.class, e.getLevel1().getDate(), cal.getTimeZone());
		...
		lblIteration.setText(String.format("Iteration: %d of %d", e.getIteration(), neuralContext.getPredictionSamples()));
